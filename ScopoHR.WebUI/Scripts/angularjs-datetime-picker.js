(function () {
    ...
    var tmpl = [
      ...
      '  </div>',
      '  <div class="adp-days daysHide" ng-click="setDate($event)">',
      ...
      //'    <label class="timeLabel">Current Time:</label> <span class="timeValue">{{("0"+inputHour).slice(-2)}} : {{("0"+inputMinute).slice(-2)}}</span><br/>',
