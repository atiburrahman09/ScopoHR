...
namespace ScopoHR.WebUI.Helpers
{
    ...
    class BiometricDeviceService : IZKEM
    {
        private CZKEM device = new CZKEM();
        private BiometricDeviceService()
        {

        }
        private static BiometricDeviceService _instance;

        public static BiometricDeviceService Instance()
        {
            if (_instance == null)
            {
                _instance = new BiometricDeviceService();
            }
            return _instance;
        }
        ...
        {
            return device.Connect_Net(IPAdd, Port);
        }

        public bool DisableDeviceWithTimeOut(int dwMachineNumber, int TimeOutSec)
        {
            return device.DisableDeviceWithTimeOut(dwMachineNumber, TimeOutSec);
        }
        ...
        {
            return device.EnableDevice(dwMachineNumber, bFlag);
        }

        public bool ReadAllGLogData(int dwMachineNumber)
        {
            return device.ReadAllGLogData(dwMachineNumber);
        }
        ...
        {
            return device.SSR_GetGeneralLogData(dwMachineNumber, out dwEnrollNumber, out dwVerifyMode, out dwInOutMode, out dwYear, out dwMonth, out dwDay, out dwHour, out dwMinute, out dwSecond, ref dwWorkCode);
        }
